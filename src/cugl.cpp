...
namespace cugl
{
    ...
    CUGLErrorType cuglError = static_cast<CUGLErrorType>(CUGL_NO_ERROR);

    CUGLErrorType getError()
    {
        CUGLErrorType currentValue = cuglError;
        cuglError = static_cast<CUGLErrorType>(CUGL_NO_ERROR);
        return currentValue;
    }
...
//}
    ...
    void PixelMap::write(const char *bmpFileName)
    {
        ...
        const unsigned short _PLANES = 1;
